...
import ru.elPrezidanto.FinanceTrackerApp.service.FinancialGoalService;
...
public class FinancialGoalPageController {
    ...
    public String createTransactionForGoal(
        ...
        financialGoalService.createTransactionForGoal(goalId, name, amount, transactionDate, description, type);
